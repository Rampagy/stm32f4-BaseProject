...
arm_sdk_install: ARM_SDK_FILE := $(join $(word 1,$(subst $(SPLIT_STRING), ,$(notdir $(ARM_SDK_URL)))),.zip)
ARM_SDK_DIR := "$(TOOLS_DIR)/$(ARM_SDK_FILE)"
...
ifneq ($(OSFAMILY), windows)
	...
	$(info $(V1) powershell -noprofile -command Expand-Archive -Force -DestinationPath $(ARM_SDK_DIR) -LiteralPath "$(DL_DIR)/$(ARM_SDK_FILE)")
